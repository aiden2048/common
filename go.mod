module github.com/aiden2048/common

go 1.23.5

require (
	github.com/aiden2048/pkg v0.0.0-20250710032503-93670ea63c9d
...
require (
	...
	golang.org/x/exp/errors v0.0.0-20250620022241-b7579e27df2b // indirect
